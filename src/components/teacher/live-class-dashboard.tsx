        ...
        <Card className="border-green-200 bg-green-50">
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <div className="flex gap-2">
                <Input value={streamCredentials.serverUrl} readOnly />
                <Button 
                  size="icon" 
                  variant="outline"
                  onClick={() => copyToClipboard(streamCredentials.serverUrl)}
                >
            ...
            <div>
              ...
              <div className="flex gap-2">
                <Input value={streamCredentials.streamKey} readOnly type="password" />
                <Button 
                  size="icon" 
                  variant="outline"
                  onClick={() => copyToClipboard(streamCredentials.streamKey)}
                >
                  <Copy className="w-4 h-4" />
                </Button>
              </div>
