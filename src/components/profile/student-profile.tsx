...
import { BookOpen, Calendar, Star, User, PlayCircle, BarChart3 } from "lucide-react"
          ...
          <Card>
            <CardContent className="p-6 text-center">
              <Avatar className="w-24 h-24 mx-auto mb-4">
                <AvatarImage
                  src={userData.profileImage || `/placeholder.svg?height=96&width=96&text=${userData.name.charAt(0)}`}
                />
              ...
              <div className="mt-4 space-y-2">
                ...
                <EditProfileModal userData={userData} onProfileUpdate={handleProfileUpdate} />
              </div>
            </CardContent>
          </Card>
        </div>
                    ...
                    <Card key={course._id} className="hover:shadow-md transition-shadow">
                      ...
                      <CardContent className="p-4">
                        ...
                        <p className="text-sm mb-3">
                          <span className="font-medium">Instructor:</span> {course.teacher.name}
                        </p>
                        <div className="flex justify-between items-center">
                    ...
                    <Card key={review._id}>
                      <CardContent className="p-6">
                        <div className="flex justify-between items-start mb-3">
                          <div>
                            <h4 className="font-medium">{review.course.name}</h4>
