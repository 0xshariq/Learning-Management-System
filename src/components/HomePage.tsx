      ...
      <main className="flex-1">
        ...
        <section className="py-20 bg-gradient-to-b from-background to-muted">
          <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-8">
            ...
            <ScaleIn delay={0.2} className="flex-1 flex justify-center">
              <Image
              ...
              {[1, 2, 3].map((i) => (
                <SlideIn key={i} direction="up" delay={i * 0.1}>
                  <div className="bg-card p-6 rounded-lg">
                    ...
                    <p className="text-muted-foreground">
                      "The courses on EduLearn are top-notch. I've learned so much in such a short time and have already
                      applied my new skills to real-world projects."
                    </p>
                  </div>
                </SlideIn>
              ))}
