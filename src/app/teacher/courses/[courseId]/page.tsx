...
async function getCourseWithDetails(courseId: string, teacherId: string) {
  ...
  try {
    ...
    return {
      ...
      videos: videos.map((video): VideoWithStringId => ({
      ...video,
      _id: video._id.toString(),
      })),
      students: enrolledStudents.map((student): StudentWithStringId => ({
      ...student,
...
export default async function TeacherCoursePage({
  ...
  console.log("Teacher Course Page - User Session:", session.user);
