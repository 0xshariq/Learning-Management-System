...
import { ArrowLeft, Edit, Eye, EyeOff, Trash2, Video, Users, PlayCircle, Settings, UserX } from "lucide-react"
...
async function getCourseWithDetails(courseId: string, teacherId: string) {
  ...
  try {
    const course = await Course.findOne({ _id: courseId, teacher: teacherId }).lean<TeacherCourse>()

    if (!course) {
      return null
    }

    const videos = await VideoModel.find({ course: courseId }).sort({ position: 1 }).lean<VideoData[]>()
...
export default async function TeacherCoursePage({ params }: TeacherCoursePageProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        <Link href="/teacher/courses" className="flex items-center text-sm text-muted-foreground hover:text-primary">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <Badge variant="outline">{course.price === 0 ? "Free" : `₹${course.price}`}</Badge>
              </div>
            </div>
          ...
          <Tabs defaultValue="overview" className="w-full">
            ...
            <TabsContent value="videos" className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <VideoUploadModal courseId={course._id} />
              </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    ...
                    <Button variant="outline" className={course.isPublished ? "text-amber-600" : "text-green-600"}>
                      {course.isPublished ? (
                        <>
