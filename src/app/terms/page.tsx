      ...
      <Card>
        <CardContent className="pt-6">
          <div className="prose prose-sm max-w-none">
            ...
            <p>
              By accessing or using our platform, you agree to be bound by these Terms. If you disagree with any part of
            ...
            <p>
              All course content provided through our platform is for educational purposes only. We do not guarantee the
              accuracy, completeness, or usefulness of any information provided in the courses.
            </p>
            <p>
              You may not reproduce, distribute, modify, create derivative works of, publicly display, publicly perform,
              republish, download, store, or transmit any of the material on our platform, except as permitted by these
              Terms or with the prior written consent of the content owner.
            </p>
