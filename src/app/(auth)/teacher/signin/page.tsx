...
const signInSchema = z.object({
  email: teacherValidationSchema.shape.email,
  password: teacherValidationSchema.shape.password,
})
  ...
  async function onSubmit(data: SignInFormValues) {
    ...
    try {
      const response = await signIn("credentials", {
        ...
        role: "teacher", // Add role to verify on server
        redirect: false,
      })
    ...
    <div className="container flex items-center justify-center py-12">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>Enter your credentials to access your teacher account</CardDescription>
        </CardHeader>
        <CardContent>
          {(authError || error) && (
