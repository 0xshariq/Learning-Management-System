...
import { Users, BookOpen, DollarSign, UserCheck, BarChart3, GraduationCap, Star, TrendingUp } from "lucide-react"
...
export default async function AdminDashboard() {
  ...
  // Get recent courses
  const recentCourses = await Course.find().sort({ createdAt: -1 }).limit(5).populate("teacher", "name").lean()

  // Get recent users (both students and teachers)
  const recentStudents = await Student.find().sort({ createdAt: -1 }).limit(3).lean()
  const recentTeachers = await Teacher.find().sort({ createdAt: -1 }).limit(3).lean()
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Monitor platform performance and manage the learning ecosystem</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Active learners on platform</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">{publishedCourseCount} published</p>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="flex items-center">
              ...
              <span className="text-2xl font-bold">
                {publishedCourseCount > 0 ? ((publishedCourseCount / courseCount) * 100).toFixed(1) : 0}%
              </span>
            </div>
            <p className="text-xs text-muted-foreground mt-1">Published vs total courses</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center">
              ...
              <span className="text-2xl font-bold">
                {studentCount > 0 ? ((reviews.length / studentCount) * 100).toFixed(1) : 0}%
              </span>
            </div>
            <p className="text-xs text-muted-foreground mt-1">Students who reviewed</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Monthly statistics and growth trends</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-[300px] flex items-center justify-center bg-muted/30 rounded-md">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  Interactive charts and detailed insights will be displayed here
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Newly created courses on the platform</CardDescription>
          </CardHeader>
          <CardContent>
                ...
                >
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-muted-foreground">
                      By {course.teacher?.name || "Unknown"} • {new Date(course.createdAt).toLocaleDateString()}
                    </div>
