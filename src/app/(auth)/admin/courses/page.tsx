        ...
        <TabsContent value="published">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage courses that are live on the platform</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <Card key={course._id.toString()} className="overflow-hidden">
                    <div className="relative aspect-video">
                      <Image
                        src={
                          course.imageUrl ||
                          `/placeholder.svg?height=200&width=400&text=${encodeURIComponent(course.name)}`
                        }
                        alt={course.name}
                        fill
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-sm">By {course.teacher.name}</span>
                        <DropdownMenu>
